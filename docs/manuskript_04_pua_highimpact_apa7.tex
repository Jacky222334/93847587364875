...
\input{../outputs_pua/tables/table1_descriptives_tabular.tex}
...
\centering
\begin{threeparttable}
\input{../outputs_pua/tables/table2_main_model_tabular.tex}
\begin{tablenotes}[para,flushleft]
...
\centering
\begin{threeparttable}
\input{../outputs_pua/tables/table3_model_comparison_tabular.tex}
\begin{tablenotes}[para,flushleft]
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{../outputs_pua/figures/figure2_response_surface_heatmap.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{../outputs_pua/figures/figure3_pua_residual_scatter.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{../outputs_pua/figures/figure4_forest_main_model.png}
